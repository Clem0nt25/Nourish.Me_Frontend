				...
				<div>
					...
					<button type="button">
						<label htmlFor="bulk-up">
							Bulk Up - <br />
							Gain muscle with as little fat as possible.
						</label>
					</button>
				</div>
				<div>
					...
					<button type="button">
						<label htmlFor="get-strong">
							Get Strong - <br />
							Gain maximum muscle and concern less about fat.
						</label>
					</button>
				</div>
				<div>
				...
				<div>
					...
					<button type="button">
						<label htmlFor="get-lean">
							Get Lean - <br />
							Lose weight while maintaining muscle as much as possible.
						</label>
					</button>
				</div>
				<div>
					...
					<button type="button">
						<label htmlFor="keep-shape">
							Keep Shape - <br />
							Keep your current body shape and track a healthy diet.
						</label>
					</button>
				</div>
			</div>
